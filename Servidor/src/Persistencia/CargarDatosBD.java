...
public class CargarDatosBD {	
	...
	public static void Cargar() throws SecurityException, HeuristicMixedException, HeuristicRollbackException, RollbackException, SystemException {
		...
		//se le asocian los niveles al mundo
		...
		ayudaP3 = new Ayuda("La integral es el area bajo la curva de una funcion");
		...
		ayudaP4 = new Ayuda("La integral es el area bajo la curva de una funcion");
		...
		ayudaP5 = new Ayuda("La integral es el area bajo la curva de una funcion");
		...
		// asocio los problemas a los niveles
		...
		//agrego el mundo a la bd (se inserta lo demas en forma cascade)
		...
		//se insertan los jugadores en la bd
